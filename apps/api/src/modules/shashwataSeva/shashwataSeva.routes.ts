...
import { ShashwataSevaController } from './shashwataSeva.controller.js';
import { authGuard } from '../../guards/auth.guard.js';
import { roleGuard } from '../../guards/role.guard.js';
import { Role } from '@temple/shared';

export function registerShashwataSevaRoutes(fastify: FastifyInstance, controller: ShashwataSevaController) {
